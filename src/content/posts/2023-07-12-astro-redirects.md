...
You _used_ to be able to do this using the [Astro.redirect](https://docs.astro.build/en/reference/errors/static-redirect-not-available/) method, but it has been deprecated as of version 2.6. No worries, though. I'll be showing you a different method that Astro recommends using the `meta refresh attribute`.
